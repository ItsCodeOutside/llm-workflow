...
export interface WorkflowExecutionCallbacks {
  onLogEntry: (logEntry: Partial<NodeExecutionLog> & { nodeId: string; nodeName: string; pathId?: string; }) => void;
  onNodeStatusUpdate: (nodeId: string, updates: { isRunning?: boolean; hasError?: boolean; lastRunOutput?: string }) => void;
