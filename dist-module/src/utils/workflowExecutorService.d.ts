import { type Node, type Project, type AppSettings, type RunStep, type WorkflowExecutionCallbacks, type ProjectRun } from '../engineTypes';
export declare const substitutePlaceholdersInExecutor: (textToSubstitute: string, previousOutput: string, nodeVariables: Map<string, string>, projectVariablesMap: Map<string, string>, systemVariablesMap: Map<string, string>, allProjectNodes?: Node[]) => string;
