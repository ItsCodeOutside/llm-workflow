...
exports.DEFAULT_APP_SETTINGS = {
    llmProvider: engineTypes_1.LLMProvider.OLLAMA, // Changed to Ollama
    temperature: 0.7,
    topK: 40,
    topP: 0.95,
...
exports.NODE_COLORS = {
    [engineTypes_1.NodeType.START]: 'bg-green-600 hover:bg-green-700',
    [engineTypes_1.NodeType.PROMPT]: 'bg-sky-600 hover:bg-sky-700',
    [engineTypes_1.NodeType.CONDITIONAL]: 'bg-amber-600 hover:bg-amber-700',
    [engineTypes_1.NodeType.CONCLUSION]: 'bg-indigo-600 hover:bg-indigo-700',
    [engineTypes_1.NodeType.VARIABLE]: 'bg-teal-600 hover:bg-teal-700',
    [engineTypes_1.NodeType.QUESTION]: 'bg-cyan-600 hover:bg-cyan-700',
    [engineTypes_1.NodeType.JAVASCRIPT]: 'bg-purple-600 hover:bg-purple-700',
    [engineTypes_1.NodeType.PARALLEL]: 'bg-rose-600 hover:bg-rose-700', // Added Parallel color
    [engineTypes_1.NodeType.SYNCHRONIZE]: 'bg-lime-600 hover:bg-lime-700', // Added Synchronize color
    ERROR: 'bg-red-700',
